...
function submmition(event) {
    if (localStorage.getItem("allUsers")) {
        ...
        var current_user_data = { F_name: document.getElementById("F_name").value, L_name: document.getElementById("L_name").value, Username: document.getElementById("Username").value, Phone: document.getElementById("Phone").value, City: document.getElementById("City").value, Street: document.getElementById("Street").value, Email: document.getElementById("Email").value, Password: document.getElementById("Password").value }
        for (index in data) {
            if (current_user_data.Username == data[index].Username || current_user_data.Email == data[index].Email) {
                flag = 1;
            }
        }
        if (flag == 0) {
